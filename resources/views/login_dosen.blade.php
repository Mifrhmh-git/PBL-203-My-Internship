          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form>
              ...
              <div data-mdb-input-init class="form-outline mb-4">
                <select type="email" id="form3Example3" class="form-control form-control-lg" placeholder="Masukkan e-mail" required>
                    <option selected>Pilih Peran Anda</option>
                    <option value="dosbing">Dosen Pembimbing</option>
                    <option value="koor">Dosen Koordinator</option>
                  </select>
              ...
              <div class="text-left text-lg-start mt-3 pt-2">
                ...
                <p class="small fw-bold mt-4 pt-3 mb-0">Tidak punya akun? <a href="../registrasi/regis-dosen.html" class="link-danger">Registrasi</a></p>
                <p class="small fw-bold mt-2 pt-1 mb-0">Masuk sebagai CDC? <a href="login-cdc.html" class="link-danger">CDC</a></p>
