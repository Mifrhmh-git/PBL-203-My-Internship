...
<html lang="en">
  ...
  <body>
    ...
    <section class="vh-100" style="display: flex; flex-direction: column; justify-content: space-between; min-height: 100vh;">
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form>
              <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                <p class="lead fw-normal mb-1 mt-5 me-3">Masuk sebagai Mahasiswa</p>
              </div>
              ...
              <div class="text-left text-lg-start mt-3 pt-2">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Masuk sebagai Dosen? <a href="login-dosen.html" class="link-danger">Dosen</a></p>
